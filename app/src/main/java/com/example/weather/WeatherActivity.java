...
import static com.example.weather.util.Utility.handleAQIResponse;
import static com.example.weather.util.Utility.handleWeatherResponse;
...
import com.example.weather.gson.AQI;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh.setColorSchemeColors(R.color.white);//colorPrimary
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        {
                            Toast.makeText(WeatherActivity.this, "成功", Toast.LENGTH_SHORT).show();
...
//
//        aqiText.setText(weather.getHeWeather6().get(0).getAir_now_city().getAqi());
//        pm25Text.setText(weather.getHeWeather6().get(0).getAir_now_city().getPm25());
